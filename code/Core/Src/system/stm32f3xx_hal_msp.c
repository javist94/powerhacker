...
void HAL_DAC_MspInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    GPIO_InitStruct.Pin = CH1_VSETDAC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CH1_VSETDAC_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END DAC2_MspInit 0 */
    ...
    PA6     ------> DAC2_OUT1
    */
    GPIO_InitStruct.Pin = CH2_VSETDAC_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CH2_VSETDAC_GPIO_Port, &GPIO_InitStruct);
...
void HAL_DAC_MspDeInit(DAC_HandleTypeDef* hdac)
{
  ...
  /* USER CODE END DAC1_MspDeInit 0 */
    ...
    PA4     ------> DAC1_OUT1
    */
    HAL_GPIO_DeInit(CH1_VSETDAC_GPIO_Port, CH1_VSETDAC_Pin);
  ...
  /* USER CODE END DAC2_MspDeInit 0 */
    ...
    PA6     ------> DAC2_OUT1
    */
    HAL_GPIO_DeInit(CH2_VSETDAC_GPIO_Port, CH2_VSETDAC_Pin);
...
void HAL_SDADC_MspInit(SDADC_HandleTypeDef* hsdadc)
{
  ...
  /* USER CODE END SDADC1_MspInit 0 */
    ...
    PB2     ------> SDADC1_AIN4P
    */
    GPIO_InitStruct.Pin = VIN_VREAD_SDADC1_Pin|CH1_CREAD_SDADC1_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);
  ...
  /* USER CODE END SDADC2_MspInit 0 */
    ...
    PE9     ------> SDADC2_AIN7P
    */
    GPIO_InitStruct.Pin = CH1_VREAD_SDADC2_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CH1_VREAD_SDADC2_GPIO_Port, &GPIO_InitStruct);
  ...
  /* USER CODE END SDADC3_MspInit 0 */
    ...
    PD8     ------> SDADC3_AIN6P
    */
    GPIO_InitStruct.Pin = CH2_CREAD_SDADC3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CH2_CREAD_SDADC3_GPIO_Port, &GPIO_InitStruct);

    GPIO_InitStruct.Pin = CH2_VREAD_SDADC3_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_ANALOG;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    HAL_GPIO_Init(CH2_VREAD_SDADC3_GPIO_Port, &GPIO_InitStruct);
...
void HAL_SDADC_MspDeInit(SDADC_HandleTypeDef* hsdadc)
{
  ...
  /* USER CODE END SDADC1_MspDeInit 0 */
    ...
    PB2     ------> SDADC1_AIN4P
    */
    HAL_GPIO_DeInit(GPIOB, VIN_VREAD_SDADC1_Pin|CH1_CREAD_SDADC1_Pin);
  ...
  /* USER CODE END SDADC2_MspDeInit 0 */
    ...
    PE9     ------> SDADC2_AIN7P
    */
    HAL_GPIO_DeInit(CH1_VREAD_SDADC2_GPIO_Port, CH1_VREAD_SDADC2_Pin);
  ...
  /* USER CODE END SDADC3_MspDeInit 0 */
    ...
    PD8     ------> SDADC3_AIN6P
    */
    HAL_GPIO_DeInit(CH2_CREAD_SDADC3_GPIO_Port, CH2_CREAD_SDADC3_Pin);

    HAL_GPIO_DeInit(CH2_VREAD_SDADC3_GPIO_Port, CH2_VREAD_SDADC3_Pin);
